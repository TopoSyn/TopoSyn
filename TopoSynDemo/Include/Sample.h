...
enum SamplePolyAreas
{
	...
	SAMPLE_POLYAREA_CROSSROAD,
	SAMPLE_POLYAREA_JUMP,
};
enum SamplePolyFlags
{
	SAMPLE_POLYFLAGS_WALK		= 0x01,		// Ability to walk (ground,road).
	SAMPLE_POLYFLAGS_DECIDE		= 0x02,		// Ability to decide (crossroad).
	SAMPLE_POLYFLAGS_JUMP       = 0x04,
...
public:
	...
	virtual class bcBucketMesh* getBucketMesh() { return m_bucMesh;}
